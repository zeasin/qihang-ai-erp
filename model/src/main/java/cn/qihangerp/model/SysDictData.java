...
public class SysDictData {
    ...
    public void setDictCode(Long v) {
        this.dictCode = v;
    }
    ...
    public void setDictSort(Integer v) {
        this.dictSort = v;
    }
    ...
    public void setDictLabel(String v) {
        this.dictLabel = v;
    }
    ...
    public void setDictValue(String v) {
        this.dictValue = v;
    }
    ...
    public void setDictType(String v) {
        this.dictType = v;
    }
    ...
    public void setListClass(String v) {
        this.listClass = v;
    }
