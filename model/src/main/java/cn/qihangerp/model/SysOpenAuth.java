...
public class SysOpenAuth {
    @TableId private Long id; private String appKey; private String appSecret;
    private String whiteList; private Integer status; private String remark;
    private String createBy; private Date createTime; private String updateBy; private Date updateTime; private Integer type;
    ...
    public String getWhiteList() { return whiteList; } public void setWhiteList(String v) { this.whiteList = v; }
