...
import cn.qihangerp.service.GoodsBrandService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/api/sys-api/basic/brand")
public class GoodsBrandController {
    @Autowired private GoodsBrandService service;
    ...
    @PostMapping("/save")
    public AjaxResult save(@RequestBody GoodsBrand brand) {
