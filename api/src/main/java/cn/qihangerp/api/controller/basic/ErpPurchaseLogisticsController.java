...
@RestController
@RequestMapping("/api/sys-api/basic/carrier")
public class ErpPurchaseLogisticsController {
    @Autowired private ErpPurchaseLogisticsService service;
    ...
    @PostMapping("/save")
    public AjaxResult save(@RequestBody ErpPurchaseLogistics l) {
